...
<body>
    <section class="container">
        ...
        <main>
            ...
            <section class="banner_grandir_aventure">
                <div class="banner-title_grandir_aventure">
                    <h2>Grandir Aventure</h2>
                    <h3>Participez à des séjours qui compte vraiment!</h3>
                    <!-- <div class="badges"> -->
                    <!-- <div class="badge">
            ...
            <section class="container">
                <div class="presentation-header">
                    <h4>#MAQUETTE</h4>
                    <h2>Le projet Grandir Aventure</h2>
                </div>
