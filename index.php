            ...
            <section class="banner-container">
                <section class="banner">
                    <div class="banner-content">
                        <div class=" banner-content-text">
                            ...
                            <div class="banner-title">
                                <h1>Développer un design </br>
                                    intuitif, accessible et engageant</h1>
                        ...
                        <div class="banner-illustration">
                            <img src="images/Shapes/shape-121.svg" alt="chemin optimisé" loading="lazy">
                        </div>
                        <!-- <div class="banner-illustration">
                ...
                <div class="presentation-container">
                    ...
                    <div class="presentation-content">
                        <div class="presentation-description">
                            <h3>Nicolas Chonavey Product designer & développeur front-end sur Lyon.</h3>
            ...
            <section class="container" id="sec-2">
                ...
                <div class="grid_cards" id='list'>
                    <div class="cards_item">
                            <a href="service_design_HelloFresh.php" target="_blank">
                                <div class="card">
                                    <div class="card_image"><img src="images/HelloFresh/Mockup.png" alt="Service Design HelloFresh" loading="lazy"></div>
                                    <div class="card_content">
                                        <h3>HelloFresh</h3>
                                        <p class="card_text">Revue complète du Service Design : User Flow, Persona, Blueprint, Accompagnement etc...</p>
            ...
            <section class="container" id="competences">
                ...
                <div class="competences-list" id="list">
                    <div class="competence">
                        <img class="competence_illustration" alt="illustration d'un développeur" loading="lazy" src="images/Shapes/shape-99.svg">
                    ...
                    <div class="competence">
                        <img class="competence_illustration" alt="illustration d'un UX designer en train de travailler" loading="lazy" src="images/Shapes/shape-9.svg">
                        <div class="competence-body">
                            <h4>UX Design</h4>
                    ...
                    <div class="competence">
                        <img class="competence_illustration" alt="illustration d'une interface mobile" loading="lazy" src="images/Shapes/shape-11.svg">
                        <div class="competence-body">
                            <h4>UI Design</h4>
                    ...
                    <div class="competence">
                        <img class="competence_illustration" alt="illustration d'un homme portant un message" loading="lazy" src="images/Shapes/shape-48.svg">
                        <div class="competence-body">
                    ...
                    <div class="competence">
                        <img class="competence_illustration" alt="illustration d'un calendrier" loading="lazy" src="images/Shapes/shape-41.svg">
                        <div class="competence-body">
                    ...
                    <div class="competence">
                        <img class="competence_illustration" alt="Une main entrain de dessiner" loading="lazy" src="images/Shapes/shape-18.svg">
                        <div class="competence-body">
